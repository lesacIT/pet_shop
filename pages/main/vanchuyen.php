        ...
        <div class="mb-4" style="margin-left: 3%;">
            ...
            <div class="row">
                ...
                <div class="col-md-12 text-end">
                    <button name="capnhatvanchuyen" class="btn btn-block btn-success my-3 py-2 border"
            ...
            <div class="row d-flex justify-content-center align-items-center h-100">
                <div class="col-12">
                        ...
                        <div class="card-body p-4">
                            <div class="row d-flex justify-content-between align-items-center">
                                ...
                                <!-- HÌNH ẢNH -->
                                    ...
                                    style="width: 100px; height: 100px;" class="img-fluid rounded-3" alt="" >
                                </div>
                    ...
                    <div class="text-center m-3">
                        <a href="index.php?quanly=thongtinthanhtoan"><button type="button" class="btn btn-success btn-block btn-lg">
