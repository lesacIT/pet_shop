...
<?php
  if(isset($_SESSION['dangky'])){
    echo 'xin chào: '. '<h5 style="color: green;">' .$_SESSION['dangky']. '</h5>';
      ...
      <div class="col-12">
            ...
            <div class="row d-flex justify-content-between align-items-center">
              <div class="col-md-1 col-lg-1 col-xl-1">
               <!-- HÌNH ẢNH -->
                ...
                <img
                  src="admin/modules/quanlysp/uploads/<?php echo $cart_item['hinhanh']; ?>" style="width: 100px; height: 100px;"
              ...
              <div class="col-md-3 col-lg-2 col-xl-2 offset-sm-1">
               <!-- GIÁ -->
                <h5 class="mb-0"><?php echo number_format($cart_item['giasp'],0,',','.').'đ' ; ?></h5>
              </div>
        ...
        <div class="card">
          <div class="card-body text-end">
            ...
            <a href="pages/main/themgiohang.php?xoatatca=1">
               <button  type="button" class="text-center btn btn-danger btn-block btn-lg">Xóa tất cả</button>
            </a>
          </div>
        </div>
        ...
        ?>
          <div class="text-center m-3">
            <a href="index.php?quanly=vanchuyen"><button type="button" class="btn btn-success btn-block btn-lg">
