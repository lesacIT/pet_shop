        ...
        <div class="col-md-6 col-sm-12 description-container p-5">
            <div class="main-description">
                <form action="pages/main/themgiohang.php?idsanpham=<?php echo $row_chitiet['id_sanpham']?>" method="post">
                    ...
                    <hr>
                    <!-- GIÁ SẢN PHẨM -->
                    <p class="product-price"><?php echo number_format($row_chitiet['giasp'],0,',','.') ?></p>
                    <!-- <form class="add-inputs" method="post">
                        ...
                        <button name="add_to_cart" type="submit" class="btn btn-success btn-lg">Thêm vào giỏ hàng</button>
                    </form> -->
                    <!-- <p>
                        <input style="width: 70px;" type="number" class="form-control" 
                            name="cart_quantity" value="1" min="1" max="10">
                            Số lượng đang có: <?php #echo ($row_chitiet['soluong']) ?>
                    </p> -->
                     <p class="">
                        ...
                        <!-- <input name="add_to_cart" type="submit" value="Thêm vào giỏ hàng" class="btn btn-success btn-lg" style="background: #fa9c1b; border-color: #fa9c1b;"> -->
                     </p>   
