...
?> 
<h4 style="display: inline-block; border-bottom: 3px solid #e74c3c;">Sản phẩm mới nhất</h4>
...
<nav aria-label="Page navigation example">
  ...
  <ul class="pagination pt-5" style="padding-left:350px;">
    ...
    <li class="page-item" >
        <a <?php if($i==$page){echo 'style="background-color: #F8C8DC;"';} else{echo ''; }?> 
            href="index.php?trang=<?php echo $i; ?>" style="color: #e2619f;" class="page-link fs-4 me-3" >
            <?php echo $i; ?></a></li>
    <?php
        }
    ?>
